...
if (!set || !clear) {
  ...
  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
    ...
    isCallable$8(global$b.postMessage) &&
...
var isThenable = function (it) {
  var then;
  return isObject$1(it) && isCallable$6(then = it.then) ? then : false;
};
...
var styles$6 = {"obs":"observation-module_obs__dWhTB","image":"observation-module_image__khpXf"};
...
function TaxonPanel(props) {
  return jsx("div", Object.assign({
    className: styles$5['container']
  }, {
    children: jsx("h1", {
      children: "Welcome to TaxonPanel!"
    })
  }));
}
...
function Loader(props) {
  return jsx("div", Object.assign({
    ...
    children: jsx("h1", {
      children: "Welcome to Loader!"
    })
  }));
}

var generalStyles = {"page":"general-module_page__FxUnt","grid":"general-module_grid__x3dH-","obsLabel":"general-module_obsLabel__fZ18d","loader":"general-module_loader__Tcx4R","loaderBg":"general-module_loaderBg__wsjnN","count":"general-module_count__1RFbc"};
...
function RecentObservations(props) {
  return jsx("div", Object.assign({
    ...
    children: jsx("h1", {
      children: "Welcome to RecentObservations!"
    })
  }));
}
...
function SeasonalityGraph(props) {
  return jsx("div", Object.assign({
    className: styles$1['container']
  }, {
    children: jsx("h1", {
      children: "Welcome to SeasonalityGraph!"
    })
  }));
}
...
function InatComponents(props) {
  return jsx("div", Object.assign({
    className: styles['container']
  }, {
    children: jsx("h1", {
      children: "Welcome to InatComponents!"
    })
  }));
}

export { CommonTaxa, CommonTaxaLabel, Favourites, FavouritesLabel, InatComponents, Observation, RecentObservations, SeasonalityGraph, TaxonPanel, index as api, dateUtils, numberUtils };
