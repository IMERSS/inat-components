...
root.render(
	<TaxonPanel
		...
		tabDescs={{
			recentDesc: "This page lists the most recent butterfly and moth observations made in BC. Click on any of them to go to the inaturalist site for more information.",
